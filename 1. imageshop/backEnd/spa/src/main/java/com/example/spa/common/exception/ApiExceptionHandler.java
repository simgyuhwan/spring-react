...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        // 에러 전달을 통일시키기 위해서 ApiErrorInfo 를 생성하고 그 안에 exception 을 넣고 전달한다.
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        restError.setMessage(sbMessage.toString());
        return super.handleExceptionInternal(ex, restError, headers, status, request);
    }
    ...
    protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        for (FieldError fieldError : fieldErrors) {
            apiErrorInfo.addDetailInfo(fieldError.getObjectName(), fieldError.getDefaultMessage());
        }
